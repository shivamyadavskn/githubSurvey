...
// import { useSearchParams } from "react-router-dom"; // React Router hook for URL params
...
export default function SearchInterface() {
  ...
  function getTimeRange(timeRange) {
    ...
    switch (timeRange) {
      case "day": // Last 24 hours
        rangeStart = now - 24 * 60 * 60;
        break;
      case "week": // Past week
        rangeStart = now - 7 * 24 * 60 * 60;
        break;
      case "month": // Past month
        rangeStart = now - 30 * 24 * 60 * 60;
        break;
      case "year": // Past year
        rangeStart = now - 365 * 24 * 60 * 60;
        break;
      default: // "all" or unsupported values
        rangeStart = 0; // Represents no filtering
        break;
    }
  ...
  const handleFilterChange = (key, value) => {
    ...
    setSearchParams({ query, ...filters, [key]: value, page: 0 });
  };
